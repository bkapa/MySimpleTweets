...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "8YrmddAWKKEb45u4xvpWN7cQP";       // Change this
	public static final String REST_CONSUMER_SECRET = "wMLy1LE8SRb89xa7Rx1xwz51o1DOCfjfKe0GLR9HUGtEUTGrEX"; // Change this
...
/*	// DEFINE METHODS for different API endpoints here
	...
	*/
	...
	public void postTweet(String tweetText,AsyncHttpResponseHandler handler){
		...
		RequestParams params = new RequestParams();
		params.put("status",tweetText.toString());
